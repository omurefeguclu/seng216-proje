...
/**
 * Base class that represents a row from the 'warehouse_product_stock' table.
 *
 *
 *
 * @package    propel.generator.DbModel.Base
 */
abstract class WarehouseProductStock implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\DbModel\\Map\\WarehouseProductStockTableMap';
    ...
    /**
     * Initializes internal state of DbModel\Base\WarehouseProductStock object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>WarehouseProductStock</code> instance.  If
     * <code>obj</code> is an instance of <code>WarehouseProductStock</code>, delegates to
     * <code>equals(WarehouseProductStock)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[WarehouseProductStockTableMap::COL_ID] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[WarehouseProductStockTableMap::COL_AMOUNT] = true;
        }
    ...
    public function setCreatedOn($v)
    {
        ...
        if ($this->created_on !== null || $dt !== null) {
            if ($this->created_on === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_on->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[WarehouseProductStockTableMap::COL_CREATED_ON] = true;
            }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : WarehouseProductStockTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : WarehouseProductStockTableMap::translateFieldName('WarehouseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->warehouse_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : WarehouseProductStockTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : WarehouseProductStockTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : WarehouseProductStockTableMap::translateFieldName('CreatedOn', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = WarehouseProductStockTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\DbModel\\WarehouseProductStock'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildWarehouseProductStockQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see WarehouseProductStock::setDeleted()
     * @see WarehouseProductStock::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWarehouseProductStockQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WarehouseProductStockTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(WarehouseProductStockTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(WarehouseProductStockTableMap::COL_WAREHOUSE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'warehouse_id';
        }
        if ($this->isColumnModified(WarehouseProductStockTableMap::COL_PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'product_id';
        }
        if ($this->isColumnModified(WarehouseProductStockTableMap::COL_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'amount';
        }
        if ($this->isColumnModified(WarehouseProductStockTableMap::COL_CREATED_ON)) {
            $modifiedColumns[':p' . $index++]  = 'created_on';
        }

        $sql = sprintf(
            'INSERT INTO warehouse_product_stock (%s) VALUES (%s)',
    ...
    {
        $pos = WarehouseProductStockTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['WarehouseProductStock'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['WarehouseProductStock'][$this->hashCode()] = true;
        $keys = WarehouseProductStockTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(WarehouseProductStockTableMap::COL_ID)) {
            $criteria->add(WarehouseProductStockTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(WarehouseProductStockTableMap::COL_WAREHOUSE_ID)) {
            $criteria->add(WarehouseProductStockTableMap::COL_WAREHOUSE_ID, $this->warehouse_id);
        }
        if ($this->isColumnModified(WarehouseProductStockTableMap::COL_PRODUCT_ID)) {
            $criteria->add(WarehouseProductStockTableMap::COL_PRODUCT_ID, $this->product_id);
        }
        if ($this->isColumnModified(WarehouseProductStockTableMap::COL_AMOUNT)) {
            $criteria->add(WarehouseProductStockTableMap::COL_AMOUNT, $this->amount);
        }
        if ($this->isColumnModified(WarehouseProductStockTableMap::COL_CREATED_ON)) {
            $criteria->add(WarehouseProductStockTableMap::COL_CREATED_ON, $this->created_on);
        }
    ...
    {
        $criteria = ChildWarehouseProductStockQuery::create();
        $criteria->add(WarehouseProductStockTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \DbModel\WarehouseProductStock (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DbModel\WarehouseProductStock Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        return (string) $this->exportTo(WarehouseProductStockTableMap::DEFAULT_STRING_FORMAT);
    }
