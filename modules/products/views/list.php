...
<div class="bg-primary text-white p-4">
    <div class="container-lg d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex justify-content-center align-items-center gap-2" data-datatable-filter-group="#entities-table">
            <input name="Name" class="form-control " style="min-width: 160px; max-width: 240px; field-sizing: content;" type="search" placeholder="Search for Product Name...">
                ...
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="Name" id="productName"
                               placeholder="Enter product name" data-validate="isRequired('You must enter a name')">
                    </div>
...
<script type="text/javascript">
    const entitiesTable = initDatatable('#entities-table', '/api/products');
